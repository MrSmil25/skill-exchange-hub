...
function MatchCard({ skill, student, faculty, rating, proof, credits, avatar, teaching, requested, onRequest }: (typeof learnMatches)[number] & { teaching: boolean; requested: boolean; onRequest: () => void }) {
